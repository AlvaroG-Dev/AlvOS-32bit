...
static int fat32_is_directory_empty(fat32_fs_t *fs, uint32_t dir_cluster); // Nueva: declaración static
int fat32_validate_cluster_chain(fat32_fs_t *fs, uint32_t first_cluster, uint32_t *out_chain_length);
...
int fat32_write(vfs_node_t *node, const uint8_t *buf, uint32_t size, uint32_t offset);
int fat32_readdir(vfs_node_t *node, vfs_dirent_t *buf, uint32_t *count, uint32_t offset);
...
int fat32_find_free_dir_entry(fat32_fs_t *fs, uint32_t dir_cluster, uint32_t *sector, uint32_t *offset);
int fat32_create_dir_entry(fat32_fs_t *fs, uint32_t dir_cluster, const char *name, uint32_t first_cluster, uint32_t size, uint8_t attributes);
int fat32_calculate_free_clusters(fat32_fs_t *fs, uint32_t *free_clusters, uint32_t *next_free_cluster);
...
int fat32_format_with_params(disk_t *disk, uint16_t sectors_per_cluster, uint8_t num_fats, const char *volume_label);
