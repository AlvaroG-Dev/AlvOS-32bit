...
__asm__(
    ...
    "req_str_end:\n"
    "\n"
    "    # Sección de datos extra para inflar el binario > 4096 bytes\n"
    "    .section .data\n"
    "    .align 4\n"
    "    large_dummy_buffer: .space 8192, 0xCC # 8KB de relleno con NOPs/CC\n"
    "    footer_msg: .ascii \"[HELLO] This is a heavy executable (8KB+ "
    "code)\\r\\n\"\n"
    "    footer_msg_len = . - footer_msg\n");